...
const endpoint = 'https://blue-magical-patron.solana-devnet.discover.quiknode.pro/16059fc6b52eccb20d29f649a05ef73875341fb3/'; //Replace with your RPC Endpoint
...
const MY_TOKEN_METADATA: UploadMetadataInput = {
    name: "Spartans",
    symbol: "S",
    description: "This is a test token that belongs to Spartans!",
    image: "https://appdevelopermagazine.com/scripts/resize/?path=/images/news_images/Token-locking-for-Solana-App-Developer-Magazine_s6pen6ji.jpg&width=900" //add public URL to image you'd like to use
}
